...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? const NavBarPage() : const Splashscreen2Widget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          ...
          path: '/dashboardCopy',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'dashboardCopy')
              : const DashboardCopyWidget(),
        ),
        FFRoute(
          name: 'searcheForm',
          path: '/searcheForm',
          builder: (context, params) => const SearcheFormWidget(),
        ),
        FFRoute(
          name: 'pembayaran',
          path: '/pembayaran',
          builder: (context, params) => const PembayaranWidget(),
        ),
        FFRoute(
          name: 'checkout3Copy',
          path: '/checkout3Copy',
          builder: (context, params) => Checkout3CopyWidget(
            cardRef: params.getParam(
              'cardRef',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['cardProduct'],
            ),
          ),
        )
