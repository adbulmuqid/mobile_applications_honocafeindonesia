  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ProductRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final checkoutProductRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
          body: Stack(
                          ...
                          children: [
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 16.0),
                              child: Hero(
                                tag: checkoutProductRecord.productImage,
                                transitionOnUserGestures: true,
                                child: ClipRRect(
                                  borderRadius: BorderRadius.circular(0.0),
                                  child: Image.network(
                                    checkoutProductRecord.productImage,
                                    width: double.infinity,
                                    height: 430.0,
                                    fit: BoxFit.cover,
                                  ),
                            ...
                            Padding(
                              padding: const EdgeInsetsDirectional.fromSTEB(
                                  16.0, 12.0, 16.0, 16.0),
                              child: Text(
                                checkoutProductRecord.description,
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                      ...
                      Align(
                        ...
                        child: wrapWithModel(
                          ...
                          child: AddTocardWidget(
                            productComRef: widget.productRef!,
                          ),
                        ),
                      ),
                    ],
